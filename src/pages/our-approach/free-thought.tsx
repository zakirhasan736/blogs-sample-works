...
const FreeThought = () => {
	const bannerData = {
		subHeading: "Free-thought",
		title: " in the mind to innovate.",
		description: "We break down mental blocks to foster innovation.",
		isColorText: true,
		colorText: "Unravel the barriers",
	};
						...
						<div className="thought-division-details-wrap relative grid grid-cols-16 gap-5 z-50">
							...
							<div className="thought-division-details-cont-box col-span-14 col-start-3 w-full relative">
								<div className="modal-text-box absolute z-[-10]">
									<div className="modal-scroll-text scrolling-text whitespace-nowrap text-transparent text-modal-heading font-primary font-normal leading-[170%]">
										Free Thought
									</div>
								</div>
								...
								<div className="thought-division-info-text-box max-w-[940px] w-full ml-auto mt-[17px]  relative z-10">
									<h4 className="thought-division-subtitle mb-5 thought-division-title text-neu-white text-left text-text--large font-primary font-bold tracking-[.8px] leading-[190%]">
										Free-thought at Particular involves pursuing new and often
									...
									<div className="thought-division-details-box ">
										...
										<div className="thought-division-details-info-item mb-5">
											<p className="details-info-text text-text-medium-4 text-left text-neu-white font-primary font-bold leading-normal mb-3">
												This Particular philosophy is foundationally rooted in:
											</p>
											<ul className="thought-division-info-list pl-5">
												<li className="thought-division-info-text text-text-medium-4 text-left text-neu-white font-primary font-medium leading-normal mb-3 list-disc">
