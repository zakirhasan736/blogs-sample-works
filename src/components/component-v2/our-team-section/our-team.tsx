					...
					<div className="team-card-box grid grid-cols-12 gap-8 max-w-[1114px] mx-auto">
						...
						<div className="team-card col-span-4 md:col-span-6 sm:col-span-full sm:mx-auto ">
							<Image
								...
								height={311}
								className="object-cover rounded-[6px] w-[310px] h-[310px]"
								src="/images/team-jarvin.png"
								alt="jarvin Ofosu-yeboah"
							/>
							<h4 className="text-[22px] mt-3 text-left text-neu-white font-tertery font-bold leading-[32px]">
								Jarvin Ofosu-Yeboah
							</h4>
						...
						<div className="team-card col-span-4 md:col-span-6 sm:col-span-full sm:mx-auto ">
							<Image
								...
								height={311}
								className="object-cover rounded-[6px] w-[310px] h-[310px]"
								src="/images/team-adwoa.png"
								alt="adwoa aduako sabeng akosa"
							/>
							<h4 className="text-[22px] mt-3 text-left text-neu-white font-tertery font-bold leading-[32px]">
