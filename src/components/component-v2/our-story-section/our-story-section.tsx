			...
			<div className="custom-container max-w-[1220px]">
				...
				<div className="our-story-main-cont">
					<Image
						width={1134}
						height={472}
						className="rounded-[6px] w-full object-cover mb-9"
					...
					<div className="our-story-text-cont">
						<p className="description mb-7">
							...
							subpar online experiences. <br />
							<br /> This shared history fuels our relentless drive to attack
							the problem of underwhelming quality. With each project we
							undertake, we channel our years of experience, unwavering
							dedication, and our unique Particular philosophy to engineer
							exceptional digital solutions that leave a lasting impression.
							Join us on this remarkable journey, and together, we'll elevate
