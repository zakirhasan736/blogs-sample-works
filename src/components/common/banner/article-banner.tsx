...
const ArticleBanner: React.FC<ArticleBannerProps> = ({ data }) => {
	return (
		<section className="banner-varient-two-section relative z-30 bg-neu-black px-[71px] py-[120px] h-[666px] laptop-x:h-[720px] sm:h-[680px] laptop-x:px-0 laptop-x:pb-[119px] md:pb-[80px] sm;pb-[65px]">
