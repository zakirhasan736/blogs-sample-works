			...
			<div className="custom-container h-full">
				<div className="banner-varient-two-content flex items-end h-full justify-start max-w-[1430px] mx-auto">
					<div className="banner-varient-two-text-box mt-auto sm:mb-0">
						...
						<h1 className="banner-varient-title capitalize mt-5 max-w-[1000px] xxs:text-[47px] sm:text-[55px] text-[70px] laptop-x:text-[74px] laptop-x:max-w-[1160px]  text-left text-neu-white font-primary font-medium leading-none tracking-[2.7px]">
							{data.isColorText &&
