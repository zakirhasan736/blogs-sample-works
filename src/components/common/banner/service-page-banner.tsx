									...
									<div className="custom-container h-full">
										<div className="banner-services-slide-item">
											<h1
												...
												className="service-banner-title text-[70px] laptop-x:text-[67px] laptop-m:text-[60px] md:text-[65px] sm:text-[40px] xxs:text-[42px] text-left text-neu-white font-primary font-medium leading-none tracking-[3.8px]">
												{slide.title}
											</h1>
											<h5
