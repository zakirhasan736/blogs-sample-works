		...
		<>
			<div className="banner-section-contact-page">
				<div className="custom-container">
					<div className="contact-page-banner-wrapper max-w-[1430px] mx-auto bg-black py-16 pb-[100px] px-[100px] flex items-end justify-start min-h-[640px] h-full max-h-[640px] sm:py-4 sm:px-[15px] sm:min-h-[183px] sm:max-h-[183px]">
