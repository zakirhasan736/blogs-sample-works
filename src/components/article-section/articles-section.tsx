...
const ArticlesSection = () => {
	return (
		<section className="article-section pt-[120px] pb-[80px] sm:pb-14 sm:pt-[70px]">
			<div className="custom-container">
				<div className="article-sec-wrapper  mx-auto max-w-[1356px]">
					...
					<div className="article-cards-content-wrapper max-w-[1306px] w-full mx-auto">
						<Swiper
							speed={500}
							slidesPerView={1}
							spaceBetween={30}
							...
							className="article-card-slider">
							{articlesData.map((article: Article, index) => (
								<SwiperSlide key={index}>
									<div
										className="article-card-items sm:w-full"
										key={article.id}>
