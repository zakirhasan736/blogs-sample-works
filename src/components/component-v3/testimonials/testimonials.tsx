...
const TestimonialSec = () => {
	return (
		<section className="testimonials bg-[#fff] text-[#181725] pt-[101px] pb-[48px]">
			...
			<div className="testimonials-wrapper-box mt-[10px]">
				<div className="custom-container-full max-w-[1440px] w-full  relative pl-[466px] pr-0 mx-auto lg:pl-[25px] md:pl-[20px] sm:pl-4 xxs:pl-4">
					<div className="testimonilas-card-items">
						{/* ========== */}
						<div className="testimonials-card-item max-w-[371px] w-full">
							...
							<ul className="categoy-list mt-4 sm:mt-3 gap-4 flex items-center justify-start">
