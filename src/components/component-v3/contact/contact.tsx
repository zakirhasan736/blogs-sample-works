...
const ContactSec= () => {
  return (
		<section className="contact-sec bg-white">
			<div className="contact-sec-wrapper max-w-[1920px] w-full mx-auto grid gap-[90px] md:gap-[45px] sm:gap-[30px] grid-cols-12 sm:grid-cols-6">
				<div className="contact-modal-box w-full max-h-[600px] h-full col-span-6 md:col-span-5 sm:col-span-6">
					<Image
