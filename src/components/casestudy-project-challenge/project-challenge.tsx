	...
	return (
		<section
			...
			<div className="custom-container">
				<div className="case-study-challenge-wrapper-box max-w-[1430px] mx-auto">
					...
					<div
						className={`portfolio-challenge-brand-assets grid grid-cols-16 gap-12 sm:gap-8 ${paddingClass}`}>
						<div className="project-challenge-card-item col-span-9 flex flex-col-reverse items-start">
							<h3 className="project-challenge-brand-title empty:hidden text-[48px]  md:text-[36px] sm:text-[23px] text-left text-neu-white font-primary font-medium leading-none capitalize mt-10 sm:mt-6">
						...
						<div className="project-challenge-card-item col-span-7 items-start flex-col">
							<h3 className="project-challenge-brand-title empty:hidden text-[48px]  md:text-[36px] sm:text-[23px] text-left text-neu-white font-primary font-medium leading-none capitalize mb-10 sm:mb-6">
