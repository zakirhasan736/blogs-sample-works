          ...
          {ServiceDetailsData.map((service, index) => (
            <li
              ...
              ref={(el) => {
                ...
                return void 0; // Ensure the callback returns void
              }}
              className={`services-list ${
                activeServiceIndex === index ? "active" : ""
              }`}
      ...
      <div className="services-right-cont w-full">
        {ServiceDetailsData.map((service, index) => (
          <div
            ...
            data-index={index}
            ref={(el) => {
              dataIndexItemsRef.current[index] = el;
              return void 0; // Ensure the callback returns void
            }}
          ...
          >
            ...
            <div
              className={`faq-popup-wrapper fixed top-0 z-[99999] right-0 w-full h-full bg-[rgba(26,26,26,0.50)] ${
