...
const blogTitle = blogDetailsInfoItems.map(
  ...
  return (
		<div className="blogspage-main-wrapper bg-white">
			...
			<div className="single-blog-details-content-wrap gap-5 flex items-start pb-[72px] sm:pb-[20px] sm:flex-col custom-container max-w-[1440px] pl-[139px] laptop-m:pl-[30px] lg:pl-[24px] md:pl-[20px] sm:pl-[16px] pr-0 pt-[64px]">
			...
			<div className="single-blog-details-featured-blog pt-[177px] pb-[141px]">
				<div className="custom-container">
					<div className="section-title-box mb-12 md:mb-8 sm:mb-6 flex items-center justify-between gap-[30px]">
						<h3 className="section-title text-[24px] text-[#181725] font-primary font-normal leading-[38.4px] tracking-[5%]">
							See more Particular Articles
						</h3>
						<Link
							href="/contacts"
							className="flex items-center justify-center h-12 max-w-[106px] w-full rounded-[4px] border border-[#181725] text-[#181725] ">
							Book A Call
						</Link>
					</div>
						...
						<div className="blog-card-item col-span-6 sm:col-span-6">
							...
							<div className="blog-card-cont-box">
								<ul className="blog-category-lists mb-[19px] sm:mb-[12px] flex flex-wrap gap-[18px] items-center">
									<li className="blogs-category-list text-[12px] text-center text-[#181725] font-accent font-normal leading-[150%] flex items-center justify-center border border-[#181725] p-2 rounded-full h-[34px]">
										Web Design
									</li>
									<li className="blogs-category-list text-[12px] text-center text-[#181725] font-accent font-normal leading-[150%] flex items-center justify-center border border-[#181725] p-2 rounded-full h-[34px]">
										UX/UI
								...
								<Link href="/articles/how-much-does-a-website-cost-in-2024">
									<h4 className="blog-title mb-4 leading-[38.4px] tracking-[5%] font-normal font-primary text-[24px] md:text-[20px] sm:text-[18px] text-[#181725]">
										How much does a website cost in 2024?
									</h4>
								</Link>
								<p className="blog-desc text-[16px] sm:text-[12px] font-accent font-normal leading-6 text-left text-[#181725]">
