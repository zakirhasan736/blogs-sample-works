...
Thanks for using Color Craft By particular!`;
					...
					<div className="hero">
						<div className="hero-text">
							<h1 className="text-[65px] text-left font-primary font-medium leading-[1.2] capitalize mb-[50px] sm:mb-7">
								Visualize Your <span className="color-effect">Colors</span>
								<br  /> 
								On a Real Website
							</h1>
							<p className="subtitle text-[26px] text-left font-primary font-medium leading-[1.3] max-w-[660px]">
								Choosing a color palette for your website? <br className="sm:hidden" /> Use the Toolbar below to realize your choices.
							</p>
				...
				<main className="overflow-hidden laptop-x:gap-20 laptop-m:gap-16 lg:gap-16">
					<div className="custom-container our-activities-section max-w-[1430px] pb-[100px] sm:pb-16">
						<div className="part1" id="why">
							<h2 className="text-[48px] font-bold text-center font-primary leading-none mb-16 sm:mb-8 sm:text-[32px]">Why Realtime Colors?</h2>
							<div className="part1-cards grid grid-cols-12 gap-10 lg:gap-7 sm:gap-5 sm:flex">
								<div className="part1-card px-[40px] pb-[119px] pt-12 rounded-[10px] bg-[#292929] h-[588px] sm:h-auto sm:py-16  col-span-4 md:col-span-6">
									...
									<h3 className="subtitle highlight text-[32px] text-center font-primary font-medium leading-none">Saves time</h3>
					...
					<div className="custom-container how-it-works-sectiob max-w-[1430px] pb-[100px] sm:pb-16">
						<div className="part2 grid grid-cols-16 gap-20 lg:gap-12 md:gap-6 sm:flex" id="how">
							<div className="part2-left col-span-6 sm:col-span-full sm:mb-7">
								<h2 className="text-[48px] text-left sm:text-center text-primary font-primary font-bold leading-none sm:text-[32px]">How Does it Work?</h2>
							...
							<div className="part3-cards grid grid-cols-12 gap-5 sm:flex lg:gap-5 sm:gap-5">
								<div className="part3-card sm:col-span-full col-span-4 md:col-span-6 bg-[#5A5A5A]  min-h-[571px] md:min-h-[450px]">
									<div className="part3-card-text w-full">
										...
										<h2 className="text-[30px] font-bold text-center font-primary leading-none">Basic</h2>
										<p className="text-[26px] font-normal text-center font-primary leading-none mt-6">Free</p>
										<div className="part3-list mt-5">
											<div className="list max-w-[200px] mx-auto  py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
												</svg>
												<p className="text-[18px] font-normal text-center font-primary leading-none">Choose any color</p>
											</div>
											<div className="list max-w-[200px] mx-auto   py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
												</svg>
												<p className="text-[18px] font-normal text-center font-primary leading-none">Export all you want</p>
											</div>
										</div>
									</div>
								...
								<div className="part3-card sm:col-span-full col-span-4 md:col-span-6 bg-[#F2EFEF]  min-h-[571px] md:min-h-[450px]">
									<div className="part3-card-text w-full">
										...
										<h2 className="text-[30px] font-bold text-center font-primary leading-none text-secondary mb-6">*Most Popular*</h2>
										<h2 className="text-[30px] font-bold text-center font-primary leading-none text-black">Pro</h2>
										<p className="text-[26px] font-normal text-center font-primary leading-none mt-6 text-black">£0.00 p/m</p>
										<div className="part3-list mt-5">
											<div className="list max-w-[200px] mx-auto  py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
												</svg>
												<p className="text-[18px] font-normal text-center font-primary leading-none text-black">Choose any color</p>
											</div>
											<div className="list max-w-[200px] mx-auto   py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
												</svg>
												<p className="text-[18px] font-normal text-center font-primary leading-none text-black">Export all you want</p>
											</div>
											<div className="list max-w-[200px] mx-auto   py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
												</svg>
												<p className="text-[18px] font-normal text-center font-primary leading-none text-black">Get a big thank you for checking this site out</p>
											</div>
										</div>
									</div>
								...
								<div className="part3-card sm:col-span-full col-span-4 md:col-span-6 bg-[#5A5A5A]  min-h-[571px] md:min-h-[450px]">
									<div className="part3-card-text w-full">
										...
										<h2 className="text-[30px] font-bold text-center font-primary leading-none">Enterprise</h2>
										<p className="text-[26px] font-normal text-center font-primary leading-none mt-6">£0.00 p/m</p>
										<div className="part3-list mt-5">
											<div className="list max-w-[200px] mx-auto  py-3">
												<svg className="w-[24px] flex-[24px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
													<path d="M19.78 2.2002L24 6.4202L8.44 22.0002L0 13.5502L4.22 9.3302L8.44 13.5502L19.78 2.2002ZM19.78 5.0002L8.44 16.3602L4.22 12.1902L2.81 13.5502L8.44 19.1702L21.19 6.4202L19.78 5.0002Z" fill="black" />
					...
					<div className="custom-container faq-accordion-section pb-[100px] sm:pb-16 max-w-[1430px]">
						<div className="part4" id="faq">
							<div className="part4-heading">
								<h2 className="font-primary font-bold text-[48px] text-center leading-none mb-16 sm:mb-10">FAQ(Frequently Asked Questions)</h2>
							</div>
						...
						<div className="toolbar" id="toolbar">
							...
							<div className="option secbuttn rollout">
								<input
									...
									data-coloris
								/>
								<label htmlFor="secbuttn" className="text-black">Secondary Button</label>
							</div>
