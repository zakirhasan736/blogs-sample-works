...
export default function sitemap(): MetadataRoute.Sitemap {
    const NEXT_PUBLIC_API_URL = process.env.NEXT_PUBLIC_API_URL || "https://www.particularagency.co.uk/";
	return [
		{
		...
		{
			url: `${NEXT_PUBLIC_API_URL}case-studies`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
		{
			url: `${NEXT_PUBLIC_API_URL}case-studies/ai-and-humanity`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
		{
			url: `${NEXT_PUBLIC_API_URL}case-studies/hult-ib-school`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
		{
			url: `${NEXT_PUBLIC_API_URL}case-studies/village-of-genal`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
		{
			url: `${NEXT_PUBLIC_API_URL}case-studies/zenbase`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
		...
		{
			url: `${NEXT_PUBLIC_API_URL}features/colour-craft`,
			lastModified: new Date(),
			changeFrequency: "daily",
			priority: 0.5,
		},
